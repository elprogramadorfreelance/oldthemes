...
$(document).ready(function() {
	$('#ge-mailinglist-form').ajaxForm(function(data) {
		if (data==3){alert('Veuillez entrer une adresse valide.')}
...
<div id="ge-header-frame">
  <div class="ge-header">
    <div class="ge-navigation">
      ...
      <!-- Idioma -->
      <div class="banderas"> <a href="http://www.es.nouveauvisage.fr"><img src="<?php bloginfo('template_url'); ?>/images/bandesp.gif" alt="Español" width="15" height="10" /></a> | <a href="http://www.nouveauvisage.fr"><img src="<?php bloginfo('template_url'); ?>/images/bandfr.gif" alt="Français" width="15" height="10" /></a> </div>
      <!-- /idioma -->
      <!-- phone -->
      <div class="ge-phone">
      ...
      <!-- /phone -->
       ...
       <!-- sidebar -->
    <div id="ge-sidebar">
      <div class="ge-logo"><a href="http://www.nouveauvisage.fr"><img src="<?php bloginfo('template_url'); ?>/images/ge-logo.png" alt="Nouveau Visage" width="120" height="110" /></a></div>
      <div class="ge-sidebar-text">
        <p><?php echo get_option('mensaje_logo'); ?></p>
      </div>
      <div class="ge-search">
        <form action="#" method="get" id="ge-search-form">
          <fieldset>

            <label for="search" class="none">Search</label>
            <input name="search" id="search" type="text" value="Search" onfocus="if (value =='Search') value=''" onblur="if (value=='') value='Search'"/>
...
<div class="sp-bl-navigation">
        <ul>
      <?php if ( function_exists('dynamic_sidebar') && dynamic_sidebar('sidebarblog') ) : else : ?>
      <?php endif; ?>
    </ul>
        <!-- /side navigation -->
